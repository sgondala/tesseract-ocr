...
CONFIG_CLEAN_FILES = tesseract.pc
...
ACLOCAL = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_CPPFLAGS =  -O2 -DNDEBUG
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/missing autoconf
AUTOHEADER = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/missing autoheader
AUTOMAKE = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/missing automake-1.14
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -pg
CPP = gcc -E
CPPFLAGS =  -pg -I/usr/local/include/leptonica -I/usr/include/leptonica -pthread -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12  
CXX = g++
CXXCPP = g++ -E
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
OTOOL64 = 
PACKAGE = tesseract
PACKAGE_BUGREPORT = http://code.google.com/p/tesseract-ocr/issues/list
PACKAGE_DATE = 08/13
PACKAGE_NAME = tesseract
PACKAGE_STRING = tesseract 3.04
...
STRIP = strip
VERSION = 3.04
abs_builddir = /home/sashank/Acads/RnD/gitTess/tesseract-ocr
abs_srcdir = /home/sashank/Acads/RnD/gitTess/tesseract-ocr
abs_top_builddir = /home/sashank/Acads/RnD/gitTess/tesseract-ocr
abs_top_srcdir = /home/sashank/Acads/RnD/gitTess/tesseract-ocr
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/sashank/Acads/RnD/gitTess/tesseract-ocr/config/install-sh
...
tesseract.pc: $(top_builddir)/config.status $(srcdir)/tesseract.pc.in
...
doc: doc-dummy
	...
	version="3.04" name="tesseract" \
	doxygen $(top_srcdir)/doc/Doxyfile

doc-pack: doc
	-chmod a+r $(top_srcdir)/doc/html/*
	 @tar --create --directory=$(top_srcdir)/doc/html --verbose --file=- . | gzip -c -9 > $(top_srcdir)/tesseract-3.04-doc-html.tar.gz;
